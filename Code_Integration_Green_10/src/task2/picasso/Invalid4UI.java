 ...
 */
public class Invalid4UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Entered values do not form a triangle");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Invalid4UI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Invalid4UI().setVisible(true);
            }
        });
    }
